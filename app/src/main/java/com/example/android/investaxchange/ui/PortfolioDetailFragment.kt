...
class PortfolioDetailFragment : Fragment(R.layout.market_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        barsViewModel.loadBars(args.portfolioAsset.symbol, 30, n_datapoints)
        snapshotViewModel.loadSnapshot(args.portfolioAsset.symbol)
        ...
        view.findViewById<TextView>(R.id.tv_market_name).text = args.portfolioAsset.symbol
        //view.findViewById<TextView>(R.id.tv_market_description).text = snapshotViewModel.snapshot?.value.
        ...
        (requireActivity() as AppCompatActivity).supportActionBar?.title = args.portfolioAsset.symbol
    ...
    private fun getOrderRequest(qty: Int) = OrderRequest(
        symbol = args.portfolioAsset.symbol,
        qty = qty,
        side = "buy",
        type = "market",
        timeInForce = "day",
    ...
    private fun shareMarketDetail() {
        ...
        val text = getString(R.string.share_text, args.portfolioAsset.symbol, String.format("%.2f", price.toDouble()))
